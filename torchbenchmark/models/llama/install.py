...
from model import ModelArgs as LlamaModelArgs

root_dir = f"torchbenchmark/models/llama"

def hf_download(model_repo: Optional[str] = None, hf_token: Optional[str] = None) -> None:
    from huggingface_hub import snapshot_download
    checkpoint_dir = root_dir + f"/.data/checkpoints/{model_repo}"
...
def convert_hf_checkpoint(
    *,
    checkpoint_dir: Path = Path(root_dir + "/.data/checkpoints/meta-llama/Llama-2-7b-hf"),
    weight_map_path: str = root_dir + "/config/weight_map.json",
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_repo', type=str, default="meta-llama/Llama-2-7b-hf", help='Huggingface Repository ID to download from.')
